...
```
rclone --include "*.7z*" move /up od:up --ignore-existing -u -v -P --transfers=6 --ignore-errors --buffer-size=200M --check-first --checkers=10 --onedrive-chunk-size 102400 --header "user-agent:NONISV|Contoso|GovernanceCheck/1.0"
```
